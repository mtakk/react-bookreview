      ...
      <nav className="flex justify-between container mx-auto items-center p-4">
        ...
        {token ? (
          <>
            ...
            <li className="text-xs underline cursor-pointer" onClick={onClickToPostBook}>新規投稿</li>
            <li className="text-xs underline cursor-pointer" onClick={onClickToUserEdit}>アカウント編集</li>
            <li className="text-xs underline cursor-pointer" onClick={onClickToLogout}>
              ログアウト
            </li>
          </>
        ) : (
